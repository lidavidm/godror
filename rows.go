...
func (r *rows) ColumnTypePrecisionScale(index int) (precision, scale int64, ok bool) {
	...
	case C.DPI_ORACLE_TYPE_INTERVAL_DS, C.DPI_ORACLE_TYPE_TIMESTAMP, C.DPI_ORACLE_TYPE_TIMESTAMP_TZ, C.DPI_ORACLE_TYPE_TIMESTAMP_LTZ:
		return int64(col.FsPrecision), int64(col.Precision), true
	default:
		return 0, 0, false
	}
}
